function showData() {
    ...
    .then(data => {
        ...
        insideTempDiv.innerHTML = "The inside temperature of the serre is: " + payload.inside;
        document.getElementById("insideTemp").appendChild(insideTempDiv);

        const outsideTempDiv = document.createElement("div");
        outsideTempDiv.innerHTML = "The outside temperature of the serre is: " + payload.outside;
